...
/** Sentinel for logs recorded without a task, which are a first-class case. */
export const NO_TASK_FILTER = 'none'

interface IWorkLogFilterProps {
	tasks: Task[]
...
export function WorkLogFilter({ tasks, selectedTaskIds, onToggle, onClear }: IWorkLogFilterProps) {
