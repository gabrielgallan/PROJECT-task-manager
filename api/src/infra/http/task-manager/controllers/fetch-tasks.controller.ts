...
import { FetchTasksDto, FetchTasksResponseDto, fetchTasksSchema } from './dto/fetch-tasks.dto'
...
export class FetchTasksController {
	...
	@ApiOkResponse({ description: 'Tasks fetched successfully', type: FetchTasksResponseDto })
	@Get()
	@HttpCode(200)
	async handle(
		@CurrentUser()
