...
import { DeleteUserController } from './controllers/identity/delete-user.controller'
import { EditProfileController } from './controllers/identity/edit-profile.controller'
import { FetchSessionController } from './controllers/identity/fetch-sessions.controller'
...
import { RevokeAllSessionsController } from './controllers/identity/revoke-all-sessions.controller'
import { RevokeSessionController } from './controllers/identity/revoke-session.controller'
import { SignOutController } from './controllers/identity/sign-out.controller'
import { UploadAvatarController } from './controllers/identity/upload-avatar.controller'

@Module({
	imports: [EnvModule, AuthModule, CryptographyModule, DatabaseModule, EmailModule, StorageModule],
	controllers: [
		RegisterController,
